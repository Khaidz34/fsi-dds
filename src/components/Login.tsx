      ...
      >
        <div className="bg-white/90 backdrop-blur-2xl p-6 lg:p-8 rounded-[2.5rem] shadow-2xl border border-app-accent/5 silk-texture relative overflow-hidden">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-1 justify-center flex-wrap">
              <div className="h-px w-6 sm:w-12 bg-gradient-to-r from-transparent via-app-accent to-transparent" />
              <p className="text-xs text-app-accent font-bold tracking-[0.15em] sm:tracking-[0.3em] uppercase text-center">
