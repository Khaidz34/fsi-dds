...
export default function App() {
  ...
  return (
    <div className={`flex flex-col lg:flex-row min-h-screen text-app-ink font-sans ${theme === 'corporate' ? 'corporate-theme' : ''} bg-app-bg`}>
      {/* Mobile Header */}
      <div className="lg:hidden bg-white border-b border-app-ink/10 p-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          {/* User Info */}
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-full border border-app-accent/10 bg-app-accent flex items-center justify-center text-white font-bold text-xs">
      ...
      <main className="flex-1 flex flex-col overflow-hidden relative pb-20 lg:pb-0">
        ...
        {/* Content Area */}
        <div className="flex-1 overflow-y-auto p-4 lg:p-10 bg-[#FDFCF8] relative">
          ...
          <AnimatePresence mode="wait">
            ...
            {activeTab === 'menu' && (
              ...
              >
                ...
                {/* Menu List */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 lg:gap-6 pb-64">
                  <AnimatePresence mode="wait">
                    {isLanguageChanging ? (
                      <motion.div
                ...
                {/* Place Order Bar - Improved Layout */}
